...
(function() {
    ...
    async function initializeCanvases() {
        ...
        // Wheeler diagram should match cross-section width and have similar height
        // to accommodate 50 time units clearly
        AppState.wheelerBg.init(
            AppState.crossSectionBg.canvas.width,
            Math.round(AppState.crossSectionBg.canvas.height * 1.1)
        );
